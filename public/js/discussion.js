...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initialComponent = __webpack_require__(147);
	
	var _initialComponent2 = _interopRequireDefault(_initialComponent);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_reactDom2.default.render((0, _initialComponent2.default)(), document.getElementById('react-entry'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerInitializer = __webpack_require__(160);
	
	var _reducerInitializer2 = _interopRequireDefault(_reducerInitializer);
	...
	var ConnectedConversation = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_conversation2.default);
	
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2.default)(_redux.createStore);
	
	module.exports = function () {
	  var providedState = arguments.length <= 0 || arguments[0] === undefined ? window.__INITIAL_STATE__ : arguments[0];
	
	  var reducers = (0, _reducerInitializer2.default)(providedState);
	  var store = createStoreWithMiddleware(reducers);
	
	  return _react2.default.createElement(
	    _reactRedux.Provider,
	    { store: store },
	    _react2.default.createElement(ConnectedConversation, null)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (initialTopics) {
	  var initialState = _immutable2.default.Map({
	    topics: _immutable2.default.List(initialTopics)
	  });
	...
	function appState(state) {
	  ...
	  switch (action.type) {
	    ...
	    case _actions.GOT_TOPICS:
	      var foundTopics = action.foundTopics;
	
	      topics = state.get('topics').map(function (topic) {
	        var topicMatch = undefined;
	        ...
	        var returnTopic = topicMatch ? topicMatch : Object.assign({
	          _id: topic._id,
	          name: topic.name
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CHANGE_SEARCH_TEXT = exports.GOT_TOPICS = exports.TOGGLE_FILTER = exports.CHANGE_FILTER = undefined;
	exports.changeSearchText = changeSearchText;
	exports.toggleFilter = toggleFilter;
	exports.gotTopics = gotTopics;
	exports.searchForTopics = searchForTopics;
	...
	var GOT_TOPICS = exports.GOT_TOPICS = 'GOT_TOPICS';
	...
	function gotTopics(foundTopics) {
	  return {
	    type: GOT_TOPICS,
	...
	function searchForTopics() {
	  return function (dispatcher, getState) {
	    var state = getState();
	    var topicIds = state.get('topics').filter(function (topic) {
	      return topic.isSelected;
	    }).map(function (topic) {
	      return topic._id;
	    });
	
	    _superagent2.default.post('/api/conversation/search').send({
	      topicIds: topicIds,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _topicFilters = __webpack_require__(186);
	
	var _topicFilters2 = _interopRequireDefault(_topicFilters);
	
	var _searchField = __webpack_require__(187);
	...
	var Conversation = function (_React$Component) {
	  ...
	  _createClass(Conversation, [{
	    ...
	    value: function render() {
	      ...
	      var topics = appState.get('topics');
	      var filteredTopics = topics.filter(function (topic) {
	        return topic.discussion !== undefined;
	      });
	
	      var Topics = filteredTopics.map(function (topic, index) {
	        var hr = index !== topics.size ? _react2.default.createElement('hr', null) : null;
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'h5',
	                null,
	                ' Show me the discussion concerning: '
	              ),
	              _react2.default.createElement(_topicFilters2.default, { topics: topics, changeFilter: actions.changeFilter }),
	              Topics
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Topic = function (_React$Component) {
	  ...
	  _createClass(Topic, [{
	    ...
	    value: function render() {
	      ...
	      var notes = topic.discussion.map(function (note, index) {
	        return _react2.default.createElement(
	          "div",
	          { className: "row topic-note", key: index },
	          _react2.default.createElement(
	            "div",
	            { className: "small-2 columns" },
	            _react2.default.createElement("img", { src: note.participant.avatar, className: "topic-note-image" })
	          ),
	          _react2.default.createElement(
	            "div",
	...
	Topic.propTypes = {
	  topic: _react2.default.PropTypes.object
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopicFilters = function (_React$Component) {
	  _inherits(TopicFilters, _React$Component);
	
	  function TopicFilters() {
	    _classCallCheck(this, TopicFilters);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TopicFilters).apply(this, arguments));
	  }
	
	  _createClass(TopicFilters, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      ...
	      var Filters = topics.map(function (topic, index) {
	        var topicFilterClass = !topic.discussion ? 'topic-filter-found' : '';
	
	        return _react2.default.createElement(
	          'div',
	          { className: 'columns small-6 medium-4 large-3', key: index },
	          _react2.default.createElement(
	            'label',
	            { key: index, className: topicFilterClass },
	            _react2.default.createElement('input', { type: 'checkbox', onChange: changeFilter.bind(undefined, topic._id), checked: topic.isSelected }),
	            topic.name
	          )
	        );
	      });
	...
	exports.default = TopicFilters;
	
	TopicFilters.propTypes = {
	  topics: _react2.default.PropTypes.object,
	  changeFilter: _react2.default.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "div",
	            { className: "small-10 medium-11 columns" },
	            _react2.default.createElement("input", { type: "text", placeholder: "Search Term...", value: this.props.searchText, onChange: this._handleInputChange })
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "small-2 medium-1 columns" },
	            _react2.default.createElement(
	              "button",
	...
	SearchField.propTypes = {
	  changeSearchText: _react2.default.PropTypes.func,
	  searchForTopics: _react2.default.PropTypes.func,
